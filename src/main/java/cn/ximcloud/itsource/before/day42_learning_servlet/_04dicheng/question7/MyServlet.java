 ...
 * 查找这些方法
 **/
@WebServlet(name = "liucheng_question7", urlPatterns = "/day42/question7.php")
...
//        如果请求时GET方法,就会默认执行这里面的代码
        System.out.println("我先做完GET应该做的事情");
//        然后我再做POST该做的事情
...
////        cn.ximcloud.itsource.before.day42_learning_servlet._04dicheng.question4.MyServlet.service(MyServlet.java:69)
