<%@ page import="cn.ximcloud.itsource.day1_day47.day47_login_ordersale._03captcha.dao.impl.StudentImpl" %>
<%@ page import="cn.ximcloud.itsource.day1_day47.day47_login_ordersale._03captcha.domain.Student" %>
<%--
...
<hr>
<h3>修改学生</h3>
<form action="/day47/update_captcha" method="post">
