...
<table border="1px" cellspacing="0" style="border-color: #66CCFF;">
    ...
    <c:forEach items="${ALL_STUDENT_IN_SESSION}" var="studentList">
        <tr>
            ...
            <td><a href="/day45/homework5/stu?id=${studentList["id"]}" }>${studentList["name"]}</a></td>
            <th><a href="/day45/homework5/update?id=${studentList["id"]}">修改</a></th>
            <th><a href="/day45/homework5/remove?id=${studentList["id"]}">删除</a></th>
        </tr>
    </c:forEach>
</table>
<hr/>
