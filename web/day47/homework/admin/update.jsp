<%@ page import="cn.ximcloud.itsource.day47_login_ordersale.homework.homework1.dao.impl.UserImpl" %>
<%@ page import="cn.ximcloud.itsource.day47_login_ordersale.homework.homework1.domain.User" %><%--
