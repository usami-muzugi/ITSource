<%@ page import="cn.ximcloud.itsource.day47_login_ordersale._03captcha.dao.impl.StudentImpl" %>
<%@ page import="cn.ximcloud.itsource.day47_login_ordersale._03captcha.domain.Student" %>
<%--
